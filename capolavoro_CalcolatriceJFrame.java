...
public class capolavoro_CalcolatriceJFrame extends javax.swing.JFrame {
    ...
    public boolean containsLetters(){
        return textField.getText().toLowerCase().contains("n");
    }
    ...
    public void arithmeticOperation(){
        ...
        switch(calcoli){
            case 1 -> {
                //somma
                ans = num + Double.parseDouble(textField.getText());//string to double
                textField.setText(Double.toString(round(ans, textField.getText().length())));
            }
            case 2 -> {
                //sottrazione
                ans = num - Double.parseDouble(textField.getText());//string to double
    ...
    private void initComponents() {
        ...
        textField.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
    ...
    private void ButtonNEGPOSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonNEGPOSActionPerformed
        ...
        double app = Double.parseDouble(textField.getText());
        double ris;
       
        ris = app * -1;
        textField.setText(Double.toString(ris));
    ...
    private void ButtonDELActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonDELActionPerformed
        if(containsLetters()) textField.setText("");
